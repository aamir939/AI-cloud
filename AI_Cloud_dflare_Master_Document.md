...
![System Context Diagram](images/01-system-context.png)
...
![Bare Metal Provisioning Flow](images/02-provisioning-flow.png)
...
![Storage Architecture & Double Isolation](images/03-storage-architecture.png)
...
![Tenant Isolation Model (6 Layers)](images/04-tenant-isolation.png)
...
![Metering Pipeline Flow](images/05-metering-pipeline.png)
...
![Network VPC & Fabric Architecture](images/06-network-vpc.png)
...
![Architecture Tiers](images/07-architecture-tiers.png)
...
![Zero-Trust Defense-in-Depth](images/08-zero-trust-security.png)
...
![Tenant Onboarding Sequence](images/09-tenant-onboarding.png)
